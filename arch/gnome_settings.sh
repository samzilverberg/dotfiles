...
# attempt to reduce GUI delay of lang switch 
gsettings set org.freedesktop.ibus.general switcher-delay-time 100
...
sudo -u "$username" yay -S --noconfirm gnome-shell-extension-workspace-matrix
...
gsettings set org.gnome.desktop.wm.keybindings switch-input-source "['<Alt><Super>space', '<Ctrl><Alt>k', 'XF86Keyboard']"

gsettings set org.gnome.desktop.wm.keybindings panel-main-menu "['<Alt>F1', 'XF86LaunchA', 'XF86LaunchB']"
...
gsettings set org.gnome.shell.keybindings toggle-overview "['<Alt>F1', '<Super>Space']"
